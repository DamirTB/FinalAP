...
func (app *Applicaiton) readIDParam(r *http.Request) (int64, error) {
...
func (app *Applicaiton) writeJSON(w http.ResponseWriter, status int, data interface{}, headers http.Header) error {
...
func (app *Applicaiton) readJSON(w http.ResponseWriter, r *http.Request, dst interface{}) error {
...
func (app *Applicaiton) background(fn func()) {
...
func (app *Applicaiton) readString(qs url.Values, key string, defaultValue string) string {
	s := qs.Get(key)
	if s == "" {
		return defaultValue
	}
...
func (app *Applicaiton) readInt(qs url.Values, key string, defaultValue int, v *validator.Validator) int {
	s := qs.Get(key)
	if s == "" {
		return defaultValue
	}
